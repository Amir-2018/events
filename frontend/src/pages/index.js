                ...
                <div className="absolute inset-0 z-20 flex items-center">
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="text-center md:text-left md:max-w-3xl">
                      ...
                      <div className="flex flex-col md:flex-row gap-6 mb-10 text-gray-200 font-medium text-lg">
                        <div className="flex items-center justify-center md:justify-start gap-3 bg-white/10 backdrop-blur-md px-6 py-3 rounded-2xl border border-white/20">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                        {event.current_participants >= event.max_participants && event.max_participants > 0 ? (
                          <button disabled className="bg-red-600/80 backdrop-blur-md text-white px-10 py-5 rounded-3xl text-sm font-black uppercase tracking-widest cursor-not-allowed flex items-center justify-center shadow-lg border border-red-400">
                            Complet
                          </button>
                        ) : (
                          <button 
                        ...
                        <Link 
                          href={`/event/${event.id}`}
                          className="bg-white/10 backdrop-blur-md border border-white/30 text-white px-10 py-5 rounded-3xl text-sm font-black uppercase tracking-widest hover:bg-white hover:text-gray-900 transition-all active:scale-95 flex items-center justify-center cursor-pointer"
                        >
                          Détails
                        </Link>
                        <a 
        ...
        <section className="bg-gray-50 py-24">
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                 {[
                   { title: "Gestion Intuitive", desc: "Une interface fluide pour créer et modifier vos événements en quelques clics." },
                   { title: "Suivi en Temps Réel", desc: "Gardez un oeil sur vos inscrits et vos biens grâce à notre tableau de bord." },
