    ...
    <div className={`${className} relative`}>
      ...
      <div className="w-full h-full bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center p-8 relative z-10">
          ...
          {bienType && (
            <p className="text-blue-700 text-sm font-semibold mb-2 uppercase tracking-wide">
              {bienType}
            </p>
          )}
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a 
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-xl text-sm font-black uppercase tracking-widest hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl active:scale-95"
            >
