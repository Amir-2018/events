  ...
  return (
    <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h4 className="font-bold text-blue-900">Inviter des clients</h4>
      </div>
      
      <p className="text-sm text-[#2596d1] mb-4">
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2.5 bg-white border border-blue-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#31a7df]/20 focus:border-[#31a7df] transition-all text-sm"
        />
        {searchTerm && (
          <button
            onClick={() => {
      ...
      <div className="max-h-64 overflow-y-auto space-y-2">
        {displayedClients.length === 0 ? (
          <div className="text-center py-8 text-[#31a7df]">
          ...
          displayedClients.map((client) => (
            <div key={client.id} className="flex items-center gap-3 p-3 bg-white rounded-xl border border-blue-100 hover:border-blue-200 transition-colors">
              <input
                type="checkbox"
                id={`client-${client.id}`}
      ...
      {!searchTerm && filteredClients.length > 3 && (
        <div className="mt-4 text-center">
          <button
            ...
            className="text-sm font-medium text-[#31a7df] hover:text-[#2596d1] transition-colors flex items-center gap-1 mx-auto"
          >
            {showAll ? (
              <>
      ...
      {searchTerm && (
        <div className="mt-4 p-3 bg-blue-50 border border-blue-300 rounded-xl">
